...
parser.add_argument("-k", "--keep-snapshots", type=int, default=10, metavar="N", help="Keep defined number of snapshots and auto-remove older ones. Disable removal of older snapshots by setting value to 0. Default: 10")
parser.add_argument("--sub-dir", type=str, metavar="NAME", help="Specify sub-directory to organize snapshots.")
parser.add_argument('--read-only', metavar="BOOL", action="store", default=True, help="Takes a Boolean value. 'False' enables writable snapshots. Default: True")
